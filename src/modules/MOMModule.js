            ...
            {actions.map((a,i)=>(
              <div key={i} style={{background:T.surfaceB,borderRadius:8,border:`1px solid ${T.b1}`,padding:"11px 12px",marginBottom:8}}>
                ...
                <div style={{marginBottom:7}}>
                  <input value={a.task} onChange={e=>updAction(i,"task",e.target.value)} placeholder="What needs to be done?"
                    style={{...inputStyle}} onFocus={e=>e.target.style.borderColor=T.blu} onBlur={e=>e.target.style.borderColor=T.b1}/>
                </div>
